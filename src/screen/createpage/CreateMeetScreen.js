            ...
            <ScrollView style={styles.contents}>
                ...
                <View>
                    ...
                    <View style={styles.centeredView}>
                        ...
                        <TouchableOpacity
                            activeOpacity={1}
                            style={[styles.modalButton, meetStartDate === null ? styles.modalButtonOpen : styles.rangeStyle]}
                            onPress={() => setModalVisible(true)}
                        >
                            {meetStartDate === null ? (
                                <Text style={styles.modalTextStyle}>캘린더에서 날짜 범위 선택하러 가기</Text>) : (
                                <Text style={styles.rangeText}>{meetStartDate} ~ {meetEndDate}</Text>)
                            }
                        </TouchableOpacity>
                    </View>
                </View>
