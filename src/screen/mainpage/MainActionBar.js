...
export default function MainActionBar(props) {
    ...
    const title = props.title === 'CreateMeetScreen' ? '일정 생성' : props.title;
            ...
            <View style={{ width: screenWidth, height: 50, flexDirection: 'row', }}>
                ...
                <View style={{ width: "60%", justifyContent: 'center', flexDirection: 'row' }} >
                    <View style={{ height: 50, justifyContent: 'center' }}>
                        <Image source={require('../../asset/meetcody_logo.png')} style={{ height: 30, width: 55, resizeMode: 'contain' }} />
                    </View>
                    <View style={{ height: 50, justifyContent: 'center' }}>
                ...
                <View style={{ width: "20%", height: 50 }} >
                    {props.title === 'CreateMeetScreen' ?
                        ...
                        <TouchableOpacity style={{ height: 50, }}>
                            <Entypo name="magnifying-glass" size={30} style={{ paddingTop: 10, textAlign: 'right', paddingRight: 30 }} />
                        </TouchableOpacity>
                    }
